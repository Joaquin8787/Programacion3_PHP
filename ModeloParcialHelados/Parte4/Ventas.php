...
class Venta{
    ...
    public function setPrecioPedido(float $precio,int $stock){
        $this->_precioPedido = ($precio * $stock);
    }
    ...
    public function __construct($emailUsuario = "", $saborHelado = 'Chocolate', $tipoHelado = "", $vasoHelado = "",$stockHelado = 0,$precioPedido=null,$fechaPedido = new DateTime('now')){
        $this->setID();
        ...
        $this->setPrecioPedido($precioPedido,$stockHelado);
    }
